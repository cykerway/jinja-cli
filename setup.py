...
setup(
    ...
    description='a command line interface to jinja;',  # Optional
    ...
    url='https://github.com/cykerway/jinja-cli',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Cyker Way',  # Optional
...
#    author_email='',  # Optional
    ...
    keywords='jinja python template engine',  # Optional
